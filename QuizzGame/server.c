...
int players_number = 0;     // numarul de jucatori
int session = 0;           // numarul sesiunilor
int timer_length = 20 ;   // timpul pentru o sesiune de la primul client
int time_limit = 10;     // numarul de secunde in care un client poate raspunde la o intrebare
...
{		
    ...
    //daca clientul nu a dat quit, continua cu clasamentul
